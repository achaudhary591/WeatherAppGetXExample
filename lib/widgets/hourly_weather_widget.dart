...
import 'package:weather_app_getx_example/model/weather_data_hourly.dart';
...
class HourlyWeatherWidget extends StatelessWidget {
  ...
  HourlyWeatherWidget({Key? key, required this.weatherDataHourly}) : super(key: key);
...
class HourlyDetails extends StatelessWidget {
  ...
  HourlyDetails({Key? key,
    ...
    required this.temp,
    required this.weatherIcon}) : super(key: key);


  String getTime(final timesStamp){
